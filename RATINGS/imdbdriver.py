...
def getIMDBUrl(peli: str) -> str:
    ...
    search_button.send_keys(f'{peli} imdb')
...
data['imdburl'] = urls
data.to_csv('/Users/cerivera/Documents/ProyectoCineMexicano/RATINGS/peliculasmexasimdblink.csv', sep=',', encoding='utf-8', index=False)
